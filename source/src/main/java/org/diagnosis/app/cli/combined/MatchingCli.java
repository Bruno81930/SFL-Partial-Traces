...
public class MatchingCli implements Runnable {
    private final static Logger logger = LoggerFactory.getLogger(MatchingCli.class);
    ...
    public void run() {
        ...
        MatchingEvaluate matchingEvaluate = new MatchingEvaluate(project, bug, percentage, data, sources, filter, times, fromIteration, report, local);
        try {
            matchingEvaluate.evaluate();
