package org.diagnosis.app.cli.combined;
...
import org.diagnosis.app.model.MatchingEvaluate;
...
@Command(name="execution",
        ...
        description = "Evaluate execution trace matching between reconstruction traces algorithms",
        sortOptions = false
)
public class ExecutionMatchingCli implements Runnable {
    private final static Logger logger = LoggerFactory.getLogger(ExecutionMatchingCli.class);
    ...
    public void run() {
        ...
        ExecutionMatchingEvaluate executionMatchingEvaluate = new ExecutionMatchingEvaluate(project, bug, percentage, data, sources, filter, times, fromIteration, report, local);
        try {
