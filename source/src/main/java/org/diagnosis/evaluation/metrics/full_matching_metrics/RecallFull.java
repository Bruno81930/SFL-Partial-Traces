...
import org.diagnosis.evaluation.metrics.matching.Recall;
...
public class RecallFull extends Metric {

    Recall recall;
    ScopeType scopeType;

    public RecallFull(ScopeType scopeType, AlgorithmType algorithm, ExecutionGraph executionGraph, HitVector fullHitVector, HitVector baselineHitVector, HitVector reconstructedHitVector, HitVector weightedReconstructedHitVector) {
        super();
        ...
        this.recall = new Recall(actualExecutionTrace, predictedExecutionTrace);
    }
    ...
    public String getName() {
        return "Recall" + this.scopeType.name();
    }
