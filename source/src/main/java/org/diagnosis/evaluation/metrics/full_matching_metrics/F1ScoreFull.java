...
import org.diagnosis.evaluation.metrics.matching.F1Score;
...
public class F1ScoreFull extends Metric {

    F1Score f1Score;
    ScopeType scopeType;

    public F1ScoreFull(ScopeType scopeType, AlgorithmType algorithm, ExecutionGraph executionGraph, HitVector fullHitVector, HitVector baselineHitVector, HitVector reconstructedHitVector, HitVector weightedReconstructedHitVector) {
        super();
        ...
        if (scopeType == ScopeType.ExecutionGraph) {
            ...
            Set<Component> filteredComponents = baselineHitVector.getFilteredComponents();
        ...
        this.f1Score = new F1Score(actualExecutionTrace, predictedExecutionTrace);
    }
    ...
    public String getName() {
        return "F1Score" + this.scopeType.name();
    }
